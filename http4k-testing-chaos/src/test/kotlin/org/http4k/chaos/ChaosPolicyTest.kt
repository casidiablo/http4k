...
import org.http4k.chaos.Trigger.Companion
import org.http4k.chaos.Trigger.Companion.TimePast
...
class ChaosPolicyTest {
    ...
    val a = ChaosStage.Repeat { blockThread.then(goSlow) }.until(Companion.of { true })
}